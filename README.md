...
## 🗓️ 2026-02-28 — «AI Engineering: программирование нового уровня абстракции»

📍 [ITMO](https://itmo.ru)

🧬 Доклад про AI-инженерию на практическом примере, на котором можно увидеть проблемы и задачи, очень напоминающие стандартное программирование production-ready систем, только на другом, более высоком, уровне абстракции. В докладе:

- Проектирование мультиагентских систем
- Trade-off между скоростью, качеством и ценой
- Параллелизм и асинхронность
- Безопасность
- Приемка и верификация качества результата
- Observability и тестирование

*Запись и материалы появятся после 2026-02-28*

---

## 🗓️ 2026-01-21 — «Эй-ай-больно: Как подготовиться к внедрению активно кодирующих LLM»

📍 [SPb Python Meetup](https://t.me/spbpythonnews/315)
...
🎥 **[Запись (YouTube)](https://www.youtube.com/watch?v=7IT7Zp0k6KQ)**
